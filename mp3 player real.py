...
class FrameApp(Frame):
    def __init__(self,master):
        ...
        self.b2 = Button(self, text="PREVIOUS SONG", command=self.previous_song,bg='AntiqueWhite1',width=40)
        self.b2.grid(row=4, column=5)

        self.b3 = Button(self, text="PAUSE/UNPAUSE", command=self.toggle,bg='AntiqueWhite1', width=40)
        self.b3.grid(row=3, column=5)

        self.b4 = Button(self, text="NEXT SONG", command=self.next_song,bg='AntiqueWhite1', width=40)
        self.b4.grid(row=5, column=5)

        self.b5 = Button(self, text="ADD TO PLAYLIST", command=self.add_to_list,bg='AntiqueWhite1',width=40)
        self.b5.grid(row=1, column=5)

        self.label1 = Label(self, fg='Black', font=('Helvetica 12 bold italic',10), bg='ivory')
        self.label1.grid(row=6, column=5)
...
window.title("20PW06 and 20PW33 MP3 Player")
